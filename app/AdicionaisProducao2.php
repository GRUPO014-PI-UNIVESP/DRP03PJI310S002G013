...
<!-- Área Principal -->
<div class="main">
  <br><p style="font-size: 20px; color: whitesmoke">Dados de Produção</p><?php
  if($rowPedido['ETAPA_PROCESS'] < 6){ echo 'o Número de Pedido informado ainda está em execução.' . '<br><br>'; ?><button class="btn btn-warning" onclick="location.href='./AdicionaisProducao.php'">Voltar</button> <?php }
  else { ?>
    <div class="row g-2">
      <div class="col-md-2">
